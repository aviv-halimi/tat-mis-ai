  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <p>
          Processes all POs with <code>po_status_id = 5</code>, sends invoice PDFs to Gemini, and sets
          <code>invoice_validated = 1</code> when the AI total matches <code>r_total</code>. Also extracts
          <code>payment_terms</code> (e.g. 20 from "NET 20") when found. The script runs in the background so the page
          does not time out; updates appear below as it runs.
        </p>
        <p>
