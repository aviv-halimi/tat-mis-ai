...
Rules:
- total_amount_due: The final amount owed for THIS invoice only (number, e.g. 1234.56). Use the total of the current invoice — the sum of its line items plus its taxes/fees/shipping, minus any credits or discounts that are applied to this invoice. Do NOT use the customer's overall account balance, statement balance, aging total, or "total amount due on account" that rolls in prior unpaid invoices. If the document shows both a current invoice total (e.g. "Invoice Total", "Amount Due This Invoice", "Balance Due") and a larger account-level number (e.g. "Account Balance", "Total Balance Due", "Statement Balance", "Past Due + Current"), always pick the current-invoice number, even when the account balance is more prominent or labeled "Total Due".
