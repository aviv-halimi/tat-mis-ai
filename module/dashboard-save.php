...
echo '</div>
<div class="row">';
	if (strlen($_Session->dashboard)){
		echo '';
		//echo $_Session->dashboard;
	}
	/*else {
		echo "<script type='module' src='https://us-west-2b.online.tableau.com/javascripts/api/tableau.embedding.3.latest.min.js'></script><tableau-viz id='tableau-viz' src='https://us-west-2b.online.tableau.com/t/tatmaster/views/LiveSalesDashboard/LiveDashboardExec' hide-tabs  toolbar='bottom'></tableau-viz>";
	}*/
    ?>
</div>
<script>
  // Function to set Tableau viz dimensions
  function setTableauVizSize() {
    const viz = document.getElementById('tableau-viz');
	const container = viz.parentElement;
  ...
  // Run on page load
  document.addEventListener('DOMContentLoaded', setTableauVizSize);
