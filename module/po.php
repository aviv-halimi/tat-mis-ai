...
$(document).ready(function(e) {
  ...
  $(document).on("click", ".btn-po-menu-sync", function(e) {
    ...
    // Run sync via CLI in background (async) to avoid 504; poll for result.
    ...
    $.ajax({
      ...
      if (res && res.started) {
        $statusText.text("Syncing in background (no timeout). Waiting for result…");
...
if ($_po_id && $_po_status_id == 1) {
  ...
  <div class="panel panel-default mt-3" id="po-brand-menu-panel">
    ...
    <div class="panel-body">
      ...
      <p class="text-muted small mt-2 mb-0">Sync runs in the background (CLI) so it does not time out. The page will poll for the result; if you leave the page, use &quot;Reload to see changes&quot; to load the last result. See <a href="doc/po-menu-sync-504-timeout.md" target="_blank" rel="noopener">doc/po-menu-sync-504-timeout.md</a> for server setup.</p>
