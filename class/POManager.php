...
class POManager extends SessionManager {
  ...
  function GetPO($po_id) {
    return getRs("SELECT t.po_id, t.po_code, t.po_name, t.email, t.po_number, t.po_type_id, t.description, t.vendor_id, t.store_id, t.num_products, t.num_orders, t.date_created, t.admin_id, t.po_status_id, t.discount_name, t.discount_rate, t.discount_amount, t.discount, t.tax_rate, t.tax_amount, t.tax, t.subtotal, t.total, t.r_total, t.ai_total, t.in_qbo, t.date_ordered, t.date_requested_ship, t.date_schedule_delivery, t.po_filename, t.invoice_filename, t.invoice_number, t.payment_terms, t.coa_filename, t.coa_filenames, t.date_received, t.is_confirmed, t.date_confirmed, t.confirmed_by_vendor_id, t.invoice_validated, r.po_reorder_type_id, r.po_reorder_type_name, r.field_level, t.vendor_name, s.po_status_name, s.caption AS status_caption, s.description AS status_description, s.back_caption, s.back_description FROM po_status s INNER JOIN (po_reorder_type r INNER JOIN po t ON t.po_reorder_type_id = r.po_reorder_type_id) ON s.po_status_id = t.po_status_id WHERE " . is_enabled('t,r') . " AND t.po_id = ?", array($po_id));
  }
